...
const Section3 = () => {
  return (
    <div className="flex flex-col-reverse lg:flex-row items-center py-[126px] gap-[48px] lg:gap-[81px] max-w-7xl w-full mx-auto">
      <img
      ...
      <div className="space-y-[32px] lg:space-y-[48px] px-[20px] lg:px-0">
        <div className="space-y-[18px] lg:space-y-4">
          ...
          <div className="opacity-60 max-w-[712px]">
            ...
            where our expertise effortlessly aligns with the diversity of your
            project demands. Infused with a strong commitment to security and
            AI-driven innovation, our core focus is on delivering tailored,
            transparent, and timely solutions that exceed your unique tech
